...
> [!NOTE] Для быстрого создания **CRUD** контроллера с включённой валидацией для входящих данных, вы можете использовать **CRUD Generator** из **NestJS CLI**: 
> <br> `$ nest g resource [name]`.
...
> [!NOTE] Узнать больше о `async` / `await` вы можете [тут](https://learn.javascript.ru/async-await).
