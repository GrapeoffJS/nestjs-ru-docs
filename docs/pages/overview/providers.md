...
> [!NOTE] Так как **Nest** даёт возможность проектировать и организовывать зависимости в более объектно-ориентированном стиле, мы крайне рекомендуем вам следовать принципам [**SOLID**](https://en.wikipedia.org/wiki/SOLID).
...
Чтобы получить поставщиков внутри функции **bootstrap()** (например, в автономном приложении без контроллеров, или,
чтобы использовать конфигурацию сервиса в процессе подготовки приложения к запуску) смотрите статью
